                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <div class="d-flex align-items-center py-3">
                            <img class="me-2" src="{{ asset('assets/img/generic/logo-flims.png') }}" alt=""
                                width="40" /><span class="font-sans-serif">FLIMS</span>
                        </div>
                    </a>
                </div>
                @include('Partials.pimpinan')
            </nav>
                    ...
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">
                                Badiklat Kejaksaan<span class="d-none d-sm-inline-block"></span><br class="d-sm-none" />
                                &copy; 2023
                            </p>
                        </div>
                        <div class="col-12 col-sm-auto text-center">
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight">
                            <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start">
                    <img class="me-2" src="assets/img/icons/left-arrow-from-left.svg" width="20"
                        alt="" />
                    <div class="flex-1">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card">
                            <img class="img-fluid img-prototype" src="assets/img/generic/card.png"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant">
                            <img class="img-fluid img-prototype" src="assets/img/generic/vibrant.png"
