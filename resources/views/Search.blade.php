    ...
    <div class="card mb-3">
        ...
        background-image: url(../../../assets/img/icons/spot-illustrations/corner-4.png);">
                            ...
                            <div class="card-body position-relative">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h4>DE_001_CASE_001_JAKARTA_10_2023</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#tambah-bbe").click(function() {
                ...
                let formBBE = `
                        <div class="tab-content">
                            <div class="card-body bg-light">
                                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                    ...
                                    <form>
                                        <div class="mb-3">
                            <input class="form-control" id="basic-form-name" type="text" value="CASE_001_JAKARTA_10_2023" />
                                        </div>
                        ...
                        background-image: url(../../../assets/img/icons/spot-illustrations/corner-4.png);">
                                            ...
                                            <div class="card-body position-relative">
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <h4>DE_00${bbeCount}_CASE_001_JAKARTA_10_2023</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                $("#form-container").find("input[id^='uploadImage1']").change(function() {
                    var reader = new FileReader();
                    var img = $(this).closest('.card-body').find('img[id^="uploadPreview1"]');
                ...
                $("#form-container").find("input[id^='uploadImage2']").change(function() {
                    var reader = new FileReader();
                    var img = $(this).closest('.card-body').find('img[id^="uploadPreview2"]');
                    reader.onload = function(e) {
                        img.attr('src', e.target.result);
                    }
                    reader.readAsDataURL(this.files[0]);
